...
public class PackageUtils {
    ...
    public static final String myFilePath = Environment
			.getExternalStorageDirectory().getPath() + "/market/";
	
	public static final boolean checkInstalled(Context context,String packageName) {
		PackageInfo packageInfo = null;

		try {
		    PackageManager manager = context.getPackageManager();
			packageInfo = manager.getPackageArchiveInfo(myFilePath + packageName, 0);
